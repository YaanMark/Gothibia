...
SpellInfo = {
    Default = {
        ...
        ['Blood Transfusion'] = { id = 301, name = 'Blood Transfusion', words = 'exura sanguis', type = 'Instant', level = 1, mana = 10, soul = 0, maglevel = 0, icon = '', clientId = 5, group = { [1] = 1000 }, needTarget = true, parameter = false, range = 4, exhaustion = 1000, premium = false, vocations = {11, 12}, special = false, source = 0 },
