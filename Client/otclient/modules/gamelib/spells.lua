...
SpellInfo = {
    Default = {
        ...
        ['Sanguine Bolt'] = { id = 300, name = 'Sanguine Bolt', words = 'exori sanguis', type = 'Instant', level = 1, mana = 5, soul = 0, maglevel = 0, icon = '', clientId = 112, group = { [1] = 2000 }, needTarget = true, parameter = false, range = 5, exhaustion = 2000, premium = false, vocations = {11, 12}, special = false, source = 0 },
        ['Blood Transfusion'] = { id = 301, name = 'Blood Transfusion', words = 'exura sanguis', type = 'Instant', level = 1, mana = 10, soul = 0, maglevel = 0, icon = '', clientId = 5, group = { [2] = 1000 }, needTarget = false, parameter = false, range = -1, exhaustion = 1000, premium = false, vocations = {11, 12}, special = false, source = 0 },
