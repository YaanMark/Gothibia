...
SpellInfo = {
    Default = {
        ...
        ['Vampiric Touch'] = { id = 302, name = 'Vampiric Touch', words = 'exori vita sanguis', type = 'Instant', level = 1, mana = 25, soul = 0, maglevel = 0, icon = '', clientId = 6, group = { [1] = 2000 }, needTarget = true, parameter = false, range = 4, exhaustion = 2000, premium = false, vocations = {11, 12, 16, 17}, special = false, source = 0 },
        ['Blood Nova'] = { id = 303, name = 'Blood Nova', words = 'exori gran sanguis', type = 'Instant', level = 1, mana = 40, soul = 0, maglevel = 0, icon = '', clientId = 48, group = { [1] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 4000, premium = false, vocations = {11, 12, 16, 17}, special = false, source = 0 },
        ['Sanguine Armor'] = { id = 304, name = 'Sanguine Armor', words = 'exeta sanguis', type = 'Instant', level = 1, mana = 50, soul = 0, maglevel = 0, icon = '', clientId = 100, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 2000, premium = false, vocations = {11, 12, 16, 17}, special = false, source = 0 },
        ['Crimson Harvest'] = { id = 305, name = 'Crimson Harvest', words = 'exevo gran mas sanguis', type = 'Instant', level = 1, mana = 100, soul = 0, maglevel = 0, icon = '', clientId = 48, group = { [1] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 40000, premium = true, vocations = {11, 12, 16, 17}, special = false, source = 0 },
    }
}
